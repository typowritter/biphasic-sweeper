##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.13.0-B3] date: [Tue Jul 13 19:19:56 CST 2021]
##########################################################################################################################
...
Core/Src/tty.c \
Core/Src/sdram.c \
Core/Src/lvgl/lv_port_disp.c \
Core/Src/lvgl/lv_port_indev.c
...
# libraries
LIBS = -lc -lm -lnosys -llvgl
LIBDIR = -Lthird_party/build
